#############################################################################
# Makefile for building: New_A_2_Gui
# Generated by qmake (3.1) (Qt 5.9.1)
# Project:  ../New_A_2_Gui/New_A_2_Gui.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile ../New_A_2_Gui/New_A_2_Gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../New_A_2_Gui -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = New_A_2_Gui1.0.0
DISTDIR = /home/huynguyen/cpp/build-New_A_2_Gui-Desktop-Debug/.tmp/New_A_2_Gui1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: ../New_A_2_Gui/New_A_2_Gui.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		../New_A_2_Gui/New_A_2_Gui.pro \
		/usr/lib/libQt5Widgets.prl \
		/usr/lib/libQt5Gui.prl \
		/usr/lib/libQt5Core.prl
	$(QMAKE) -o Makefile ../New_A_2_Gui/New_A_2_Gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
UsrInfo.o: ../New_A_2_Gui/src/UsrInfo.cpp ../New_A_2_Gui/include/Account.h \
		../New_A_2_Gui/include/UsrInfo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UsrInfo.o ../New_A_2_Gui/src/UsrInfo.cpp

Account.o: ../New_A_2_Gui/src/Account.cpp ../New_A_2_Gui/include/Account.h \
		../New_A_2_Gui/include/UsrInfo.h
