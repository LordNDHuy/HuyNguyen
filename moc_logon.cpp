...
QT_MOC_LITERAL(3, 29, 25) // "on_password_returnPressed"

    },
    "logon\0on_pushButton_clicked\0\0"
...
void logon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_password_returnPressed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject logon::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_logon.data,
...
void *logon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_logon.stringdata0))
        return static_cast<void*>(const_cast< logon*>(this));
